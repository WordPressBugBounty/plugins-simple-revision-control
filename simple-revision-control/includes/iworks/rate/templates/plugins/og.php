...
echo '<p>';
esc_html_e( 'Would you like to boost your website sharing abilities?', 'simple-revision-control' );
echo '</p>';
echo '<p>';
printf(
	/* translators: %s is a plugin name with url */
	esc_html__( 'Don\'t wait, install plugin %s!', 'simple-revision-control' ),
...
"><?php echo esc_html( __( 'Install', 'simple-revision-control' ) ); ?></a></p>
